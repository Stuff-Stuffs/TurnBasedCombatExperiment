...
public class BattleMenuScreen extends TBCExScreen {
    ...
    public void tick() {
        ...
        if (!init) {
            ...
            final PressableButtonWidget buttonWidget = new PressableButtonWidget(WidgetPosition.combine(panelPos, WidgetPosition.of(0.01, 0.025, 1)), () -> 1, () -> true, 0.14, 0.1, () -> new LiteralText("Inventory"), List::of, () -> MinecraftClient.getInstance().setScreen(new BattleInventoryScreen(handle, world)));
            widget.addWidget(panelWidget);
            panelWidget.addWidget(buttonWidget);
        }
    }
}
