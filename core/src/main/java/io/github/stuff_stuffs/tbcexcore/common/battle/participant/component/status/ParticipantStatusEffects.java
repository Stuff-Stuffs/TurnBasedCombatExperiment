...
public final class ParticipantStatusEffects {
    public static final Registry<Type> REGISTRY = FabricRegistryBuilder.createSimple(Type.class, TurnBasedCombatExperiment.createId("status_effect")).buildAndRegister();
