...
public class ParticipantSelfStatListWidget extends AbstractParticipantStatListWidget {
    ...
    private void renderStatEntry(final double val, final double raw, final BattleParticipantStat stat, final MatrixStack matrices, final VertexConsumerProvider vertexConsumers) {
