...
public class BattleInventoryTabWidget extends AbstractWidget {
    ...
    public BattleInventoryTabWidget(final Supplier<List<ItemStackInfo>> stacks, final double borderThickness, final double entryHeight, final double verticalSpacing, final DoubleSupplier width, final DoubleSupplier height, final IntConsumer onSelect, final DoubleSelect doubleSelect) {
        this.stacks = stacks;
