...
public class BattleInventoryPreviewWidget extends AbstractWidget {
    ...
    public BattleInventoryPreviewWidget(final DoubleSupplier width, final DoubleSupplier height, final double infoFraction, final BattleStateView battleStateView, final Supplier<@Nullable ItemStackInfo> stackSupplier) {
        this.width = width;
        this.height = height;
    ...
    private static void renderInfo(final MatrixStack matrices, final double x, final double y, final double width, final double height, @Nullable final ItemStackInfo stackInfo, final VertexConsumerProvider vertexConsumers) {
        if (stackInfo != null) {
