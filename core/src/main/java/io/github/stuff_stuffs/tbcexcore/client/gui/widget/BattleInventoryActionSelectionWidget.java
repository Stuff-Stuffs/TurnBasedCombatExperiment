...
public class BattleInventoryActionSelectionWidget extends AbstractWidget {
    ...
    public BattleInventoryActionSelectionWidget(final BattleStateView battleState, final BattleParticipantHandle handle, final Battle battle, final List<ParticipantAction> actions) {
        this.handle = handle;
