...
public final class Parts {
    ...
    public static final Part<HandlePartData> HANDLE_PART = new Part<>(new LiteralText("Handle"), List.of(new LiteralText("A basic handle")), MaterialTags.HANDLE_MATERIALS::contains, HandlePartData.CODEC, HandlePartData::new);
    ...
    public static final Part<SimpleSwordGuardPartData> SIMPLE_SWORD_GUARD_PART = new Part<>(new LiteralText("Simple Sword Guard"), List.of(new LiteralText("A simple sword guard")), MaterialTags.SIMPLE_SWORD_GUARD_MATERIALS::contains, SimpleSwordGuardPartData.CODEC, SimpleSwordGuardPartData::new);
    public static final Part<FancySwordGuardPartData> FANCY_SWORD_GUARD = new Part<>(new LiteralText("Fancy Sword Guard"), List.of(new LiteralText("A fancy sword guard")), MaterialTags.FANCY_SWORD_GUARD_MATERIALS::contains, FancySwordGuardPartData.CODEC, FancySwordGuardPartData::new);
    public static final Part<SimplePommelPartData> SIMPLE_POMMEL = new Part<>(new LiteralText("Simple Pommel"), List.of(new LiteralText("A simple pommel")), MaterialTags.SIMPLE_POMMEL_MATERIALS::contains, SimplePommelPartData.CODEC, SimplePommelPartData::new);
